@{
    ...
    RequiredModules   = @( 
        ...
        @{ModuleName = 'Publish-RuntimeDependencyPackage'; ModuleVersion = '1.0.0'; Guid = '04c76ad8-7c85-43cc-a1c4-765fc61b6100'},
        ...
        @{ModuleName = 'UserSettings'; ModuleVersion = '1.0.0'; Guid = '124f394a-8328-4f0e-9aa0-e6c027a02e2b' }, 
        @{ModuleName = 'Assert-WebProjectConsistency'; ModuleVersion = '1.0.0'; Guid = '3c3eabeb-7ac7-41b3-a1f9-74596966cfcb' })

    # Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
    FunctionsToExport = @('Publish-ConfiguredWebSolution', 'Publish-UnconfiguredWebSolution')
