@{
    ...
    RequiredModules   = @( 
        ...
        @{ModuleName = 'Publish-WebProject'; ModuleVersion = '0.2.6'; Guid = '0180313a-e7a1-401f-a9a6-5150c41eccc9'},
        @{ModuleName = 'Get-ConfigurationTransformFile'; ModuleVersion = '0.2.6'; Guid = '87e9e091-cb36-40fa-8e3f-b7a54cc8c892'}, 
        @{ModuleName = 'Invoke-ConfigurationTransform'; ModuleVersion = '0.2.6'; Guid = '6277b189-3478-4e86-9e3b-782d74a70758' })
