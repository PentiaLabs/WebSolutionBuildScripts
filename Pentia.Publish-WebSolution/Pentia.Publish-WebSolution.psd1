@{
    ...
    RequiredModules   = @( 
        @{ModuleName = 'Pentia.Get-MSBuild'; ModuleVersion = '2.0.0'; Guid = '3d2a79b9-7b42-4c20-b2c3-03b3e492ff32'},
        ...
        @{ModuleName = 'Pentia.Publish-WebProject'; ModuleVersion = '2.0.1'; Guid = '0180313a-e7a1-401f-a9a6-5150c41eccc9'},
        ...
        @{ModuleName = 'Pentia.Publish-NuGetPackage'; ModuleVersion = '2.0.1'; Guid = 'df34c7b7-7748-40b7-8c8a-bd90c60cd8af' }
    )
